/**
 * Tạo một website có chức năng bình luận, chức năng này yêu cầu người dùng đã xác minh tài khoản mới có thể sử dụng.
...
isCommentable('comment');
console.log(isCommentable('comment'));
